...
def correr_juego(dimension_ventana:tuple)->None:
    ...
    while juego_corriendo == True:
        ...
        if pantalla_configuraciones == True: # Nuevo menu configuraciones
            ...
            menu_principal.dibujar_fondo(pantalla, const.FONDO_CONFIGURACIONES) # Cambiar fondo
            ...
            cabecera_elegir_dificultad = menu_principal.dibujar_boton(pantalla, const.LETRA, 20, "Eliga el nivel de dificultad", const.AZUL_MENU, 400, 170, 20, 20, 4, const.AZUL_CLARO)
